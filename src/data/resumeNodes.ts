  ...
  },
  {
    ...
    projectSubsections: {
      ...
      systems: [
        ...
        "Orbit (C++20 deterministic orbital mechanics simulator): built a headless 60 Hz spacecraft simulation engine in ECI space with RK4 integration, avionics-style flight-computer resource scheduling, radar/track pipelines, asynchronous UDP protobuf telemetry, replay recording, and CI-enforced determinism plus memory-safety checks.",
      ],
      security: [
