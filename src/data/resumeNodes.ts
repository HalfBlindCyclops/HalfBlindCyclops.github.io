  ...
  },
  {
    ...
    projectSubsections: {
      webDev: [
        ...
        "Portfolio Globe (this site) — Designer & Developer (2026): interactive 3D resume built with Next.js, React Three Fiber, and custom GLSL shaders; a real-time WebGL Earth with day/night terminator, procedural volumetric clouds with cyclones casting shadows on the surface, layered atmospheric scattering, and a live satellite constellation with Kepler-solved orbits and a self-healing inter-satellite comms mesh.",
      ],
      systems: [
        "Spacecraft Simulation Engine (C++20 deterministic orbital mechanics simulator): built a headless 60 Hz spacecraft simulation engine in ECI space with RK4 integration, avionics-style flight-computer resource scheduling, radar/track pipelines, asynchronous UDP protobuf telemetry, replay recording, and CI-enforced determinism plus memory-safety checks.",
